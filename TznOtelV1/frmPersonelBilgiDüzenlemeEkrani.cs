...
namespace TznOtelV1
{
    public partial class frmPersonelBilgiDüzenlemeEkrani: Form
    {
        public frmPersonelBilgiDüzenlemeEkrani()
        {
            InitializeComponent();
        }
        ...
        private void frmPersonelBilgiDüzenlemeEkrani_Load(object sender, EventArgs e)
        {
            kisiBilgiGetir();
